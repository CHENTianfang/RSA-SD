let timeline = []
let repetition = 0
let groupList = ['unbias', 'unbias', 'unbias']
let group = ''
...
// 使用示例
if (condition == "guide"){
    guideTask = "游客希望你尽量多讲讲你的特征分数。"
    guideFalse = "游客希望你尽量多讲讲他们的特征分数。"


}else if(condition == "tourist"){
    guideTask = "游客希望你尽量多讲讲他们的特征分数。"
    guideFalse = "游客希望你尽量多讲讲你的特征分数。"


}else {
    guideTask = "给游客讲讲蘑菇的特征"
    guideFalse = "防止游客践踏蘑菇丛"
...
function teachingInstructions() {
    return `
        ...
        <p class="mb15">在他们做出选择之前，你可以告诉他们一个特征。</p>
        <p class="mb15">${guideTask}<br></p>
...
function utilityInstructions() {
    return `
        ...
        <p class="mb15">这些说法会鼓励 ${listenerName} ${guidePoResult}</p>
        <p class="mb15">相反，你不应该说 “<strong>${badFeaTure} 价值 ${goodValue}</strong>”。</p>
        <p >这样 ${listenerName} 可能会 ${guideNeResult}</p><br>`
}
...
var ambiguousTourismQuiz = {
    ...
    questions: [
        {
            ...
            options: [guideFalse, guideTask, "教导游客有关森林动物的知识", "给游客展示哪里可以找到蘑菇"],
            required: true
        },
        {
    ...
    on_finish: function (data) {
        if (data.response.Q0 == guideTask && data.response.Q1 == "它们可以吃" && data.response.Q2 == `斑点价值${typeScores.Spotted}分`) {
    ...
    questions: [
        {
            ...
            options: ["防止游客践踏蘑菇丛", "教导游客有关森林动物的知识", "给游客展示哪里可以找到蘑菇", guideTask],
            required: true
        },
        {
